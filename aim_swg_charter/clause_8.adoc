...
Alignment between groups will help to define the way AIM metadata can be fit into the general purpose GeoDCAT catalogues and eventually verify it's suitability for AIM conformance Agricutlreu datasets.

===== Web Site(s)

https://github.com/opengeospatial/geosemantics-dwg/tree/master/geodcat_swg_charter
...
==== W3C/OGC Spatial Data on the Web Interest Group - TBC
